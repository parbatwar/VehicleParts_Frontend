            ...
            <div className="interactions-wrapper">
                <div className="interactions-container">
                    <div className="interactions-header">
                        <h2 className="interactions-title">SERVICE CENTER</h2>
                        <p className="interactions-subtitle">book appointments, request parts, and submit reviews</p>
                    ...
                    <div className="interaction-dashboard">
                        ...
                        {/* Box 2: Request Part */}
                        <div className="interaction-box">
                            <h3>🔧 REQUEST OUT-OF-STOCK PART</h3>
